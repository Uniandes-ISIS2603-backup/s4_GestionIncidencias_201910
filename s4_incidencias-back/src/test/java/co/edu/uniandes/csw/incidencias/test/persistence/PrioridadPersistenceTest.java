...
public class PrioridadPersistenceTest {
    ...
    public void createPrioridadTest() {
        ...
        Assert.assertEquals(newEntity.getTipoPrioridad(), entity.getId());
    }
    ...
    public void findDepartamentoTest() {
        ...
        Assert.assertEquals(entity.getId(), newEntity.getTipoPrioridad());  
    }
    ...
    public void updateDepartamentoTest() {
        ...
        Assert.assertEquals(newEntity.getTipoPrioridad(), resp.getId());
    }
}
